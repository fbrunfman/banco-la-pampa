<template>
 <div class="contenedor mt-3">
        ...
        <div class="copete p-3">
            ...
            <span class="copete-body">Envianos una foto de tu autoría o de archivo, que te resulte significativa para estos 60 años de historia del Banco de La Pampa, junto con algún comentario sobre la misma. Contanos tu visión y lo que quieras mostrar!</span>
            <span class="copete-contacto mt-2 mb-4"> Envianos la foto y tus datos (nombre, apellido y legajo) por whatsapp al 011-4199-8282.</span>
        ...
        <div class="protagonistas-titulo p-3">
            <h3> <strong>Fotos de la semana</strong></h3>
        </div>
        <div class="protagonistas-fotos p-3" >
            <div class="inner-container no-gutters">
                <div class="row no-gutters d-flex justify-content-center">
                    <div class="contenedor-fotos col-xl-3 col-md-6 col-12 text-center my-2 mx-4 " v-for="(archivo, i) in archivos" :key="i">
                        <div class="">
                            ...
                            <div class="info-video d-flex justify-content-between p-2">
                                <div class="protagonista-info text-left ml-2 mr-2">
                                    ...
                                    <div v-if="archivo.descripcion !== ''" class="sucursal"><span>Descripción: {{archivo.descripcion}}</span></div>
                                </div>
                                <div class="icono-like d-flex flex-row align-items-center">
                                    ...
                                    <span class="numero-likes" data-toggle="modal" :data-target="'#verLikes-' + i">{{archivo.likes}}</span>
                                </div>
    ...
    methods: {
        ...
        getImg() {
            ...
            .then(response => {
                ...
                this.archivos = response.data.reverse().filter(archivo => archivo.seccion_id === 2)
            })
        }
    },
    mounted () {
