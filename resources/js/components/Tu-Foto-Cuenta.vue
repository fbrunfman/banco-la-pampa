<template>
 <div class="contenedor mt-3">
        ...
        <div class="copete p-3">
            <h3 class="copete-titulo">Tenes una foto que nos cuente parte de tu historia? Enviala!</h3>
            ...
            <span class="copete-contacto mt-2 mb-4"> Envianos tu foto a <strong><a href="mailto:"> xxxxxx@xxxxxx.com</a></strong></span>
        </div>
